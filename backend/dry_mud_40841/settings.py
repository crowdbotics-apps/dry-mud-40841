"""
Django settings for dry_mud_40841 project.
...
ROOT_URLCONF = 'dry_mud_40841.urls'
...
WSGI_APPLICATION = 'dry_mud_40841.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_mud_40841 API",
    "DESCRIPTION": "API documentation for dry_mud_40841 App",
    "VERSION": "v1",
}
